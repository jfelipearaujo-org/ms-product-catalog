...
func (_m *MockCategoryRepository) GetAll(ctx context.Context, filter common.Pagination) (int64, []entity.Category, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Pagination) (int64, []entity.Category, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, common.Pagination) []entity.Category); ok {
		r1 = rf(ctx, filter)
	} else {
		if ret.Get(1) != nil {
