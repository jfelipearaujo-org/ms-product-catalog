...
func (_m *MockCategoryRepository) GetAll(ctx context.Context, pagination common.Pagination, filter repository.GetAllCategoriesFilter) (int64, []entity.Category, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Pagination, repository.GetAllCategoriesFilter) (int64, []entity.Category, error)); ok {
		return rf(ctx, pagination, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Pagination, repository.GetAllCategoriesFilter) int64); ok {
		r0 = rf(ctx, pagination, filter)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, common.Pagination, repository.GetAllCategoriesFilter) []entity.Category); ok {
	...
	if rf, ok := ret.Get(2).(func(context.Context, common.Pagination, repository.GetAllCategoriesFilter) error); ok {
