...
func (_m *MockProductRepository) GetAll(ctx context.Context, filter common.Pagination) (int64, []entity.Product, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Pagination) (int64, []entity.Product, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Pagination) int64); ok {
		r0 = rf(ctx, filter)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, common.Pagination) []entity.Product); ok {
		r1 = rf(ctx, filter)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(context.Context, common.Pagination) error); ok {
		r2 = rf(ctx, filter)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *MockProductRepository) GetByCategoryID(ctx context.Context, categoryId string, filter common.Pagination) (int64, []entity.Product, error) {
...
func (_m *MockProductRepository) GetByCategoryTitle(ctx context.Context, categoryTitle string, filter common.Pagination) (int64, []entity.Product, error) {
